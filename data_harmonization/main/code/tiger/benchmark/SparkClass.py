...
class SparkClass:
    ...
    def write_to_database_from_df(self, table, df, mode="Error") -> None:
        df.write.format("jdbc").options(
            url=f"jdbc:mysql://{config_.mysqlLocalHost}/{config_.DB_NAME}?useUnicode=true&useSSL=false&autoReconnect=true&"
                f"allowPublicKeyRetrieval=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&"
                f"serverTimezone=Europe/Amsterdam",
