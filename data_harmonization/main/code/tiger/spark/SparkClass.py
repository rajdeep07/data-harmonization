...
class SparkClass:
    ...
    def __init__(self):
        self.spark = (
            SparkSession.builder.config(
                "spark.jars",
                "/mnt/c/BigData/spark3/jars/mysql-connector-java-8.0.30.jar",
            )
            .master("local[*]")
    ...
    def read_from_database_to_dataframe(self, table, columnTypes=None):
        df = (
    ...
    def read_from_csv_to_dataframe(self, csv_file_path, header=True, inferSchema=True):
